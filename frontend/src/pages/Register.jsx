  ...
  return (
    <main className="grid min-h-screen bg-slate-50 font-sans lg:grid-cols-[.94fr_1.06fr]">
      ...
      <aside className="relative hidden place-items-center overflow-hidden bg-[linear-gradient(145deg,#0f172a,#123a2a_48%,#15803d)] p-12 text-white lg:grid">
        ...
        <div className="absolute top-11 left-12 text-lg font-bold">easypark<span className="text-green-400">.</span></div>
        <div className="relative z-10 text-center">
          <div className="mx-auto grid h-48 w-48 place-items-center rounded-full border-[14px] border-green-400 bg-white/10 shadow-[0_0_80px_rgba(34,197,94,.25)]">
            <span className="grid h-24 w-24 place-items-center rounded-[30px_30px_30px_0] bg-white text-4xl font-bold text-green-600">P</span>
          </div>
          <h2 className="mt-12 text-4xl font-bold tracking-tight">Your space is<br />waiting for you.</h2>
          <p className="mx-auto mt-4 max-w-xs text-[13px] leading-6 text-white/70">Find, reserve, and manage your parking in just a few taps.</p>
          <div className="mt-6 flex justify-center gap-5 text-[10px]"><span className="inline-flex items-center gap-1"><CheckIcon />Instant booking</span><span className="inline-flex items-center gap-1"><CheckIcon />Best locations</span></div>
        </div>
      </aside>
    </main>
  )
