  ...
  return (
    <main className="grid min-h-screen bg-slate-50 font-sans lg:grid-cols-[.94fr_1.06fr]">
      ...
      <aside className="relative hidden min-h-screen overflow-hidden bg-[#0F172A] lg:block">
        ...
        <div className="absolute inset-x-12 bottom-12 text-white"><span className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-2 text-xs font-semibold backdrop-blur"><CheckIcon /> Your parking journey starts here</span><h2 className="mt-5 text-4xl font-bold tracking-tight">A fresh start for<br />every journey.</h2><p className="mt-3 max-w-sm text-sm leading-6 text-white/80">Create your account to reserve spaces, track your vehicle, and park with confidence.</p></div>
      </aside>
    </main>
  )
}
